            ...
            <nav className="navbar navbar-expand-lg navbar-light  p-2">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav mr-auto nav-inner-container">
                        ...
                        <li className="nav-item active">
                            <Link className="nav-link" to="/register">Patient Register</Link>
                        </li>

                        <li className="nav-item active">
                            <Link className="nav-link" to="/doc-login">Doctor Login</Link>
                        </li>

                        <li className="nav-item active">
                            <Link className="nav-link" to="/doc-register">Doctor Registration</Link>
                        </li>
                    </ul>
